...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#8B4513] px-4">
      {/* Golden shining text */}
      <motion.h1
      ...
      {token ? (
        <div className="flex flex-col items-center justify-center space-y-4">
          <p className="text-white font-semibold text-center">Logged in with token: {token}</p>
          <button
